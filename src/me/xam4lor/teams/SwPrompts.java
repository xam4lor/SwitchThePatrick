...
public class SwPrompts {

	private MainClass m = null;
	
	public SwPrompts(MainClass m) {
		this.m = m;
	}
	...
	private class TeamColorPrompt extends ValidatingPrompt {
		...
		protected Prompt acceptValidatedInput(ConversationContext context,
			...
			m.createTeam((String) context.getSessionData("nomTeam"), (ChatColor) context.getSessionData("color"));
	...
	private class PlayerPrompt extends PlayerNamePrompt {
		...
		protected Prompt acceptValidatedInput(ConversationContext context,
				Player input) {
			m.getTeam((String) context.getSessionData("nomTeam")).addPlayer(input);
